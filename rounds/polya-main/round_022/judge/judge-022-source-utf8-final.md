...
Output:
# Round 22 Final Theorem and Program Judge — Source-UTF-8 Final Replacement
...
The first provenance-replacement judge, SHA-256
`c6a440e9b064bf36925b66e6aea188cce1a624a706da76d9bd74daf417f2d415`,
was also never applied. Although its graph simulation and mathematics passed,
its text-transfer step changed four intended `P` + `U+00F3` + `lya` tokens to
`P` + `U+8D38` + `lya`. The independent replacement audit, SHA-256
`ce36df00ec78daca0771bb3e29d5281531beec5d41f22ce07dce15747364eb8d`,
therefore returned FAIL on encoding provenance alone. This source-byte final
retains the corrected scope audit and restores all four tokens to U+00F3.

## Decision

**PASS. First unsupported implication: none.**

This decision closes the internal shell program target, not the general Pólya
...
```json
{
  "proof_obligations": {
    "create": [
      {
        ...
        "artifact_hashes": {
          ...
          "failed_utf8_replacement_judge": "c6a440e9b064bf36925b66e6aea188cce1a624a706da76d9bd74daf417f2d415",
          "failed_utf8_replacement_audit": "ce36df00ec78daca0771bb3e29d5281531beec5d41f22ce07dce15747364eb8d"
        },
    ...
    "update": [
      ...
      },
      {
        ...
        "next_action": "Use this as the proved strict Dirichlet Pólya theorem for all genuine three-dimensional spherical shells. External dissemination still requires a human line-by-line proof audit and a separate current literature search."
      },
      {
        "id": "POLYA-program-target",
        "title": "Program target: exact Dirichlet Pólya for non-tiling three-dimensional spherical shells",
        "status": "proved_internal",
  ...
  "round_assessment": {
    ...
    "reason": "Round 22 assembles and independently verifies the exact strict Dirichlet Pólya theorem for every genuine three-dimensional spherical shell, proves the same full class non-tiling, and closes the internal program target without a literature novelty claim."
  }
}
```
