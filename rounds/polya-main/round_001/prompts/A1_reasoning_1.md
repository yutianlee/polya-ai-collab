...
Write a deep long-form reasoning attempt. Include exact claim statements, parameter ranges, derivations, gap labels, falsification tests, source-audit needs, and a 20% section for divergent alternatives such as ellipses or certificate families.
