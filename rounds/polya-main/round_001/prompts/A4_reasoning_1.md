...
Write a rigorous formula-audit research memo of at least 2200 words. Include exact formula checks, theorem-dependency checks, parameter ranges, hidden assumptions, failure modes, at least one reproducible symbolic or numerical check plan, divergent alternatives, and confidence calibration.
...
- Use at least 6 Markdown section headings. Put major required sections on lines beginning with `## `.
