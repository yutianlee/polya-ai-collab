...
this is the complete live analytic implication chain.  The former finite
staircase, 38-state theorem, zero registry, 611-row provenance census,
programs, and interval certificates remain in the repository as historical
audit material and optional regression checks; none is a theorem premise.
\end{abstract}
