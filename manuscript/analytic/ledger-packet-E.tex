...
\]
In the live owner graph of the main paper, \(U(\rho)\) is the minimum of
\(K_0(\rho)\) and the small-hole wall \(H_0(\rho)\) when the latter is
eligible; the eligibility condition for \(H_0\) is \(\rho<\omega_0\).
...
so \(K_0(\rho)>64\).
 ...
 On the other hand, \(\rho<39/50<7/8\), and therefore
\[
...
\]
 ...
 Since \(\rho\geq\rho_c\), the small-hole wall is therefore ineligible
 throughout the stated interval.  The live upper-owner formula
 therefore gives \(U(\rho)=K_0(\rho)>64\).  Combining this with
 \(k_{11}(\rho)<64\) proves \eqref{eq:k11-K0}.
\end{proof}
