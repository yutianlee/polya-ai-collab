...
\end{equation}
The two square-root estimates follow immediately by squaring; the
displayed bounds for \(\pi\) are the classical Archimedean bounds (with
the lower one weakened to \(157/50\)).
...
Indeed,
\[
 t^2\geq\frac{11}{50}>\left(\frac7{15}\right)^2,
 \]
